...
4. **Set up automatic execution on boot:**
...
### Option B: Crontab (Fallback)

If your system doesn't use systemd or you prefer cron:
...
When activated, you'll receive a beautifully formatted HTML email with:
